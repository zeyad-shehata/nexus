...
const projectsData = [
  { title: 'Quantum Finance', cat: 'Web App', desc: 'A cutting-edge fintech platform with real-time analytics, AI-powered insights, and seamless payment processing.', tech: ['React', 'Node.js', 'AWS'], icon: getTechLogo('React', 48), metrics: '340% conversion increase', color: '#7c5cfc', client: 'FinEdge Capital', duration: '3 months', challenge: 'Building a real-time trading dashboard that handles 10K+ concurrent users with sub-second latency.' },
  { title: 'Verdant Health', cat: 'Mobile', desc: 'A comprehensive health and wellness app with AI-driven personalized recommendations and telemedicine.', tech: ['Flutter', 'Firebase', 'TensorFlow'], icon: getTechLogo('Flutter', 48), metrics: '500K+ downloads', color: '#00d4aa', client: 'Verdant Health Inc.', duration: '4 months', challenge: 'Integrating HIPAA-compliant video calls with AI-powered health assessments.' },
  { title: 'Luxe Fashion', cat: 'E-Commerce', desc: 'Premium fashion e-commerce with AR try-on, personalized styling, and global shipping integration.', tech: ['Next.js', 'Stripe', 'Sanity'], icon: getTechLogo('Next.js', 48), metrics: '250% revenue growth', color: '#ff6b9d', client: 'Luxe Retail Group', duration: '2.5 months', challenge: 'Creating a seamless AR try-on experience that works across all mobile browsers.' },
  { title: 'Neural Analytics', cat: 'AI', desc: 'An intelligent data analytics dashboard with predictive modeling and natural language querying.', tech: ['Python', 'React', 'TensorFlow'], icon: getTechLogo('TensorFlow', 48), metrics: '20hrs/week saved', color: '#ffa94d', client: 'NeuralWave AI', duration: '5 months', challenge: 'Training custom ML models on proprietary data while maintaining enterprise-grade security.' },
  { title: 'Bloom Beauty', cat: 'Branding', desc: 'Complete brand identity redesign for a luxury beauty brand including logo, packaging, and digital presence.', tech: ['Figma', 'Illustrator', 'After Effects'], icon: getTechLogo('Figma', 48), metrics: '180% brand awareness', color: '#e879f9', client: 'Bloom Beauty Co.', duration: '6 weeks', challenge: 'Maintaining brand heritage while creating a modern, Gen-Z appealing identity.' },
  { title: 'CloudSync Pro', cat: 'Web App', desc: 'Enterprise cloud management platform with automated deployment, monitoring, and cost optimization.', tech: ['Vue.js', 'Go', 'Kubernetes'], icon: getTechLogo('AWS', 48), metrics: '60% cost reduction', color: '#38bdf8', client: 'CloudSync Inc.', duration: '4 months', challenge: 'Building a multi-cloud orchestration layer that supports AWS, GCP, and Azure.' },
  { title: 'FoodieHub', cat: 'Mobile', desc: 'Food delivery app with real-time tracking, AI-based recommendations, and social dining features.', tech: ['React Native', 'Node.js', 'MongoDB'], icon: getTechLogo('Node.js', 48), metrics: '1M+ orders/month', color: '#fb923c', client: 'FoodieHub Inc.', duration: '3.5 months', challenge: 'Implementing real-time GPS tracking with live route optimization for drivers.' },
  { title: 'EcoMarket', cat: 'E-Commerce', desc: 'Sustainable marketplace connecting eco-friendly brands with conscious consumers worldwide.', tech: ['Shopify', 'Next.js', 'GraphQL'], icon: getTechLogo('GraphQL', 48), metrics: '400% growth in 6mo', color: '#4ade80', client: 'EcoMarket LLC', duration: '2 months', challenge: 'Building a carbon footprint calculator integrated into the checkout process.' },
  { title: 'PixelForge Studio', cat: 'Branding', desc: 'Creative agency rebrand with a bold, modern identity system across all touchpoints.', tech: ['Figma', 'Cinema 4D', 'Photoshop'], icon: getTechLogo('TypeScript', 48), metrics: '2x client inquiries', color: '#a78bfa', client: 'PixelForge Studio', duration: '4 weeks', challenge: 'Designing a flexible identity system that works across 50+ brand touchpoints.' },
];
